      ...
      family=Bebas+Neue&family=Geist+Mono:wght@100..900&family=Hanken+Grotesk:ital,wght@0,100..900;1,100..900&family=Host+Grotesk:ital,wght@0,300..800;1,300..800&family=Lexend:wght@100..900&family=Montserrat:wght@100..900&family=Unbounded:wght@200..900&display=swap"
        ...
        <div className="nav-bar flex h-[58px] p-5 m-5 rounded-lg backdrop-blur-lg border-[1px] border-black justify-between items-center relative z-50 overflow-hidden">
          ...
          <div className="cont flex justify-between w-1/3 hidden md:flex">
            ...
            <div
              className="text-white font-[Montserrat] cursor-pointer hover:opacity-70"
              onclick="location.href='blog-page.html'"
            >
              Blogs
            </div>
          ...
          <div className="article w-full flex justify-center items-center relative z-2">
            ...
            <div className="typo flex flex-col text-center h-fit py-8">
              ...
              <p className="text-xl text-white font-[Montserrat]">
                Discover the mysteries of the universe with a single click. Let’s
                unravel the stars together.
              </p>
            </div>
          </div>
          {/* Links */}
            ...
            <div className="text-white space-y-6 flex-1">
              ...
              <div className="bg-gradient-to-r from-gray-800 to-gray-700 rounded-2xl p-6 font-[Lexend]">
                ...
                <p className="text-gray-400">
                  ...
                  promote stargazing events, or inspire others with the wonders of the
                  universe.
                </p>
              </div>
              {/* Join Section */}
              <div className="pt-4 font-[Lexend]">
                ...
                <p className="text-gray-400 mt-2">
                  Join a global community of explorers and ignite your passion for the
                  cosmos through innovative tools and educational resources.
                </p>
              </div>
            </div>
          </div>
